...
static ssize_t his_show_bootlog(struct file *file, char __user *ubuf,
...
int show_bootlog_procfs_init(void)
{
	...
	ret = his_create_procfs_file("bootloader_log", S_IRUGO,
