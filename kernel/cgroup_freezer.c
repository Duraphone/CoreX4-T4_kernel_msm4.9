...
#else /* CONFIG_HS_CGF_NOTIFY_EVENT */
struct freezer {
...
#ifdef CONFIG_HS_CGF_NOTIFY_EVENT
	if (!strcmp(css->ss->name, HS_FREEZER_SS_NAME)
		&& !strcmp(css->cgroup->kn->name, HS_FREEZER_KN_NAME) ) {
			     ...
			     char *buf, size_t nbytes, loff_t off)
{
...
#ifdef CONFIG_HS_CGF_NOTIFY_EVENT
	{
		...
		if (!strcmp(cgroup->kn->name, HS_FREEZER_BG_KN_NAME)
			&& !cgf_notify_wq) {
